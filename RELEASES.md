...
> in this file is wrong**, at every version it appears. Newtonsoft.Json's 945/945 is separately withdrawn
...
- **Standalone binary release asset** — every tagged release now ships a self-contained
  ...
  > cache `<dir>` — see [security.md](docs/security.md#the-standalone-binary--not-published-today).
