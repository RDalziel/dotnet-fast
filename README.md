...
`dotnet format`-compatible path for whitespace and style fixes, plus a native C# linter — it starts in
milliseconds and needs no MSBuild/Roslyn load for the native rules.
