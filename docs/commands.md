...
definition+branch and use its `triggerInfo['ci.sourceSha']` as the base. Add
`--on-missing-base all` when an unavailable/unreachable base should become a conservative full build.
